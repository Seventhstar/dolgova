<template>
  <div class="event-list">
    <div :class="'event-row'+[short ? '-short': '']" v-for="event in events" @dblclick="editEvent(event)">
      <div class="event-list-item">
        ...
        <span v-if="!short">{{event.meeting_name}}</span>
        <span>баланс</span>
        <span class="event_icon" v-if="short">
        ...
        <span class="second_row" v-if="!short">{{event.comment}}</span>
